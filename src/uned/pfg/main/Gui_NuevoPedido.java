...
/**
 * Clase principal que inicia la interfaz grafica para un nuevo Pedido.
 * 
...
public class Gui_NuevoPedido extends javax.swing.JFrame {
	...
	/**
	 * Constructor que llama a un metodo privado para inicializar las variables de
	...
	private void initComponents() {
		...
		PanelTablaLayout
				.setHorizontalGroup(PanelTablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(PanelTablaLayout.createSequentialGroup()
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(botonEliminar).addGap(25, 25, 25))
						.addGroup(
								PanelTablaLayout.createSequentialGroup().addContainerGap()
										.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 326,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addContainerGap(15, Short.MAX_VALUE)));
		PanelTablaLayout
				.setVerticalGroup(PanelTablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(PanelTablaLayout.createSequentialGroup().addGap(6, 6, 6)
								.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 122,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(botonEliminar).addContainerGap(24, Short.MAX_VALUE)));
		...
		PanelArticulosLayout.setHorizontalGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(PanelArticulosLayout.createSequentialGroup().addGroup(PanelArticulosLayout
						.createParallelGroup(Alignment.LEADING)
						.addGroup(PanelArticulosLayout.createSequentialGroup().addContainerGap()
								.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(PanelArticulosLayout.createSequentialGroup()
												.addComponent(AnadirArticulo, GroupLayout.PREFERRED_SIZE, 307,
														GroupLayout.PREFERRED_SIZE)
												.addGap(0, 8, Short.MAX_VALUE))
										.addGroup(PanelArticulosLayout.createSequentialGroup()
												.addGroup(PanelArticulosLayout
														.createParallelGroup(Alignment.TRAILING, false)
														.addComponent(InfoCantidad, GroupLayout.DEFAULT_SIZE, 114,
																Short.MAX_VALUE)
														.addComponent(InfoArticulo, GroupLayout.DEFAULT_SIZE,
																GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
												.addPreferredGap(ComponentPlacement.RELATED, 33, Short.MAX_VALUE)
												.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
														.addComponent(articuloSeleccionado, GroupLayout.PREFERRED_SIZE,
																168, GroupLayout.PREFERRED_SIZE)
														.addComponent(textCantidad, GroupLayout.PREFERRED_SIZE, 84,
																GroupLayout.PREFERRED_SIZE)))))
						.addGroup(PanelArticulosLayout.createSequentialGroup()
								.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(PanelArticulosLayout.createSequentialGroup().addGap(49).addComponent(
												info_detallada_Art, GroupLayout.PREFERRED_SIZE, 230,
												GroupLayout.PREFERRED_SIZE))
										.addGroup(PanelArticulosLayout.createSequentialGroup().addContainerGap()
												.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
														.addComponent(infoID, GroupLayout.PREFERRED_SIZE, 96,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(infoNombre, GroupLayout.PREFERRED_SIZE, 96,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(infoFechaEntrada, GroupLayout.PREFERRED_SIZE, 96,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(infoprecioArt, GroupLayout.PREFERRED_SIZE, 96,
																GroupLayout.PREFERRED_SIZE))
												.addGap(18)
												.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
														.addComponent(
																idArticulos, GroupLayout.PREFERRED_SIZE, 64,
																GroupLayout.PREFERRED_SIZE)
														.addGroup(PanelArticulosLayout
																.createParallelGroup(Alignment.LEADING)
																.addGroup(PanelArticulosLayout.createSequentialGroup()
																		.addComponent(precioArt,
																				GroupLayout.PREFERRED_SIZE,
																				GroupLayout.DEFAULT_SIZE,
																				GroupLayout.PREFERRED_SIZE)
																		.addGap(12).addComponent(euro,
																				GroupLayout.DEFAULT_SIZE, 11,
																				Short.MAX_VALUE))
																.addComponent(nombreArt, GroupLayout.PREFERRED_SIZE,
																		180, GroupLayout.PREFERRED_SIZE)
																.addComponent(fecha_Ent, GroupLayout.PREFERRED_SIZE,
																		121, GroupLayout.PREFERRED_SIZE)))))
								.addGap(0, 21, 21)))
						.addContainerGap()));
		PanelArticulosLayout
				.setVerticalGroup(
						PanelArticulosLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(PanelArticulosLayout.createSequentialGroup().addContainerGap()
										...
										.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.BASELINE)
												...
												.addComponent(textCantidad, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGap(18).addComponent(AnadirArticulo).addGap(29)
										.addComponent(info_detallada_Art, GroupLayout.PREFERRED_SIZE, 28,
												GroupLayout.PREFERRED_SIZE)
										.addGap(21)
										.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.TRAILING)
												.addComponent(infoID)
												.addComponent(idArticulos, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.BASELINE)
												.addComponent(infoNombre).addComponent(nombreArt,
										...
										.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.LEADING, false)
												.addGroup(PanelArticulosLayout.createParallelGroup(Alignment.BASELINE)
														.addComponent(euro, GroupLayout.DEFAULT_SIZE,
																GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(precioArt, GroupLayout.PREFERRED_SIZE,
																GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
												.addComponent(infoprecioArt, Alignment.TRAILING,
		...
		PanelDatosPedidoLayout.setHorizontalGroup(PanelDatosPedidoLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(PanelDatosPedidoLayout.createSequentialGroup().addGroup(PanelDatosPedidoLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
						.addGroup(PanelDatosPedidoLayout.createSequentialGroup().addComponent(InfoFecha)
								.addGap(18, 18, 18).addComponent(fechaEnvio, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGroup(PanelDatosPedidoLayout.createSequentialGroup()
								.addComponent(infoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 137,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(JCombo_distribuidores, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
										javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGap(0, 80, Short.MAX_VALUE)));
		PanelDatosPedidoLayout.setVerticalGroup(PanelDatosPedidoLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(PanelDatosPedidoLayout.createSequentialGroup()
						.addGroup(PanelDatosPedidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(infoCliente).addComponent(JCombo_distribuidores,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(PanelDatosPedidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(fechaEnvio, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(PanelTabla, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(PanelDatosPedido, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGroup(layout.createSequentialGroup().addGap(10, 10, 10)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(infoPrecio, javax.swing.GroupLayout.DEFAULT_SIZE, 104,
												Short.MAX_VALUE)
										.addComponent(total, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(layout.createSequentialGroup().addGap(18, 18, 18).addComponent(precio,
												javax.swing.GroupLayout.PREFERRED_SIZE, 52,
												javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
												layout.createSequentialGroup().addGap(17, 17, 17).addComponent(
														numArticulos, javax.swing.GroupLayout.PREFERRED_SIZE, 53,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
								.addGap(27, 27, 27).addComponent(pedido, javax.swing.GroupLayout.PREFERRED_SIZE, 123,
										javax.swing.GroupLayout.PREFERRED_SIZE)))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(PanelArticulos,
				...
				layout.createSequentialGroup().addContainerGap().addGroup(layout
						...
						.addGroup(layout.createSequentialGroup()
								.addComponent(PanelDatosPedido, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(PanelTabla, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(layout.createSequentialGroup()
												.addGroup(layout
														...
														.addComponent(total).addComponent(numArticulos))
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
												.addGroup(layout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
														.addComponent(infoPrecio).addComponent(precio)))
										.addComponent(pedido, javax.swing.GroupLayout.PREFERRED_SIZE, 48,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(12, 12, 12))
						.addComponent(PanelArticulos, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap()));
		...
		botonEliminar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fila == -1) {
					JOptionPane.showMessageDialog(null, "Seleccione un articulo de la " + "tabla para eliminar",
							"Ventas", 2);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (distribuidor.equalsIgnoreCase("Selec. Distribuidor") || fe_env == null) {
					...
					JOptionPane.showMessageDialog(null,
							"Seleccione un distribuidor para " + "asignarle el pedido y una fecha valida", "Ventas", 2);
					...
					if (list.isEmpty()) {
						...
						Pedido pedido = new Pedido(
								obtenerIdDistribuidor(JCombo_distribuidores.getSelectedItem().toString()), f_actual,
								fe_env, "En Tramite", list);
						...
						if (JOptionPane.OK_OPTION == opcion) {
							...
							if (respuesta.equalsIgnoreCase("exito")) {
								...
								JOptionPane.showMessageDialog(null, "Ups...no se ha podido ingresar el pedido",
										"Ventas", 3);
							}
	...
	/**
	 * Funcion que añade articulo a la tabla del nuevo pedido, siempre que se elija
	 * un articulo de los que dispone el sistema, y se introducza una cantidad
	 * numerica
	 * 
	 * @param evt
	 */
	private void AnadirArticuloActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (seleccion.equalsIgnoreCase("Selec. Artículo") || !isNumero(cantidad)) {
			...
			JOptionPane.showMessageDialog(null,
					"No ha seleccionado un articulo" + " o la cantidad no es un valor numerico..", "Ventas", 2);
		} else {
	...
	/**
	 * Metodo que calcula el precio final de la tabla de articulos que lleva el
	 * pedido. Ese calculo es realizado dinamicamente cuando se introduce/elimina
	 * articulos de la tabla
	 * 
	 * @return
	 */
	...
	/**
	 * Funcion que, dependiendo del articulo que se quiera introducir en la tabla del pedido,
	 * comprueba si ya esta en dicha tabla, de modo que, si es asi, solo tendrá que 
	 * actualizar la cantidad pedida con lo que tenia antes, mas la nueva cantidad introducida
	 * de dicho articulo, ademas del precio.
	 * @param row Array de tipo Object que representa la fila a actualizar
	 * @return
	 */
	...
	/**
	 * Funcion que comprueba si el valor del parametro introducido es de tipo Entero
	 * @param cantidad String que representa una cantidad y la que se quiere 
	 * consultar si se trata de un numero 
	 * @return True, si el valor es de tipo Integer, False, en el caso contrario
	 */
	...
	/**
	 * Funcion que devuelve el precio unitario de un articulo que hay en la
	 * tabla del pedido.
	 * @param nombre String que representa al nombre del articulo que queremos buscar su precio.
	 * @return Devuelve el precio del articulo, o 0 en caso de no encontrarlo.
	 */
    ...
    /**
     * Función que rellena el ComoBox del Frame principal con los distribuidores, de modo que
    ...
    /**
     * Función que rellena el ComoBox del Frame principal con los articulos, de modo que
     * han sido adquiridos mediante el consumo de un web service desde el servidor.
     * @return
     */
